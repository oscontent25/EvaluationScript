...
let points = {	
	'glibc iozone fwrite/fread 4 freaders (kb/sec)': [0, 1],
	'glibc iozone fwrite/fread 4 fwriters (kb/sec)': [0, 1],
	'glibc iozone pwrite/pread 4 pread readers (kb/sec)': [0, 1],
	'glibc iozone pwrite/pread 4 pwrite writers (kb/sec)': [0, 1],
	'glibc iozone pwritev/preadv 4 initial writers (kb/sec)': [0, 1],
	'glibc iozone pwritev/preadv 4 rewriters (kb/sec)': [0, 1],
	'glibc iozone random-read 4 initial writers (kb/sec)': [0, 1],
	'glibc iozone random-read 4 random readers (kb/sec)': [0, 1],
	'glibc iozone random-read 4 random writers (kb/sec)': [0, 1],
	'glibc iozone random-read 4 rewriters (kb/sec)': [0, 1],
	'glibc iozone read-backwards 4 initial writers (kb/sec)': [0, 1],
	'glibc iozone read-backwards 4 reverse readers (kb/sec)': [0, 1],
	'glibc iozone read-backwards 4 rewriters (kb/sec)': [0, 1],
	'glibc iozone stride-read 4 initial writers (kb/sec)': [0, 1],
	'glibc iozone stride-read 4 rewriters (kb/sec)': [0, 1],
	'glibc iozone stride-read 4 stride readers (kb/sec)': [0, 1],
	'glibc iozone write/read 4 initial writers (kb/sec)': [0, 1],
	'glibc iozone write/read 4 re-readers (kb/sec)': [0, 1],
	'glibc iozone write/read 4 readers (kb/sec)': [0, 1],
	'glibc iozone write/read 4 rewriters (kb/sec)': [0, 1],
}
...
function myjudge(outputFile) {
    ...
    let end = outputFile.indexOf('END iozone-glibc', start);
    if(end == -1) return points;
    outputFile = outputFile.substring(start + 'START iozone-glibc'.length, end);
